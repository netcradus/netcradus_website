...
export const SEO_META = {
  ...
  siem: {
    path: "/platform/siem",
    title: "NetCradus SIEM | AI-Powered Log Management, Detection & Correlation",
    description:
      "NetCradus SIEM delivers real-time log ingestion, AI-driven threat correlation, and automated compliance reporting. Unified security intelligence across cloud, endpoints, and network with sub-second detection.",
    keywords: [
      "SIEM platform",
      "log management",
      "threat detection",
  ...
  trust: {
    path: "/trust",
    title: "Trust Center | Netcradus Security & Compliance",
    description:
      "Explore Netcradus security controls, compliance frameworks, data privacy, subprocessors, and customer security documentation.",
    keywords: [
      "Trust Center",
      "Security Controls",
      "ISO 27001",
  ...
  iam: {
    path: "/services/iam",
    title: "Identity & Access Management (IAM) | Netcradus",
    description:
