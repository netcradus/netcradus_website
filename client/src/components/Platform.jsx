  ...
  return (
    <div className="text-[var(--text-primary)] transition-colors duration-300">
      ...
      <section className="max-w-7xl mx-auto px-6 py-24 grid md:grid-cols-2 gap-16 items-center">
        ...
        <div>
          <span className="uppercase tracking-[0.3em] text-xs text-[var(--primary-accent)]">
            // Our Technology
          </span>

          <h1 className="text-4xl md:text-6xl font-display font-semibold mt-4 leading-tight">
            The Netcradus <br />
            <span className="italic text-[var(--text-secondary)] opacity-60">
              Security Platform
            </span>
          </h1>

          <p className="text-[var(--text-secondary)] mt-6 text-base md:text-lg leading-relaxed max-w-lg font-sans">
      ...
      <section className="max-w-7xl mx-auto px-6 py-24 grid md:grid-cols-2 gap-20 items-center">
        ...
        <div>
          ...
          <p className="text-[var(--text-secondary)] leading-relaxed mb-6 font-sans">
      ...
      <section className="max-w-7xl mx-auto px-6 py-24">
        ...
        <div className="grid md:grid-cols-3 gap-10">
          ...
          <div className="p-8 rounded-2xl border border-[var(--border-color)] bg-surface/5 transition-colors">
