...
export default function Footer() {
  ...
  return (
    <footer className="relative z-10 overflow-hidden border-t border-border bg-background pt-16 transition-colors duration-500">
        ...
        <div className="space-y-6 lg:col-span-4">
          ...
          <div className="space-y-2">
            ...
            <div className="pt-2 text-sm text-white">
              ...
              <a
                href="tel:1800121008800"
                className="mt-1 block transition hover:text-accent"
              >
                📞 1800 12100 8800
              </a>
      ...
      {/* Bottom Bar */}
      <div className="border-t border-border py-5">
        <div className="mx-auto flex max-w-screen-2xl flex-col gap-3 px-4 text-sm text-white sm:px-6 md:flex-row md:items-center md:justify-between lg:px-16 xl:px-24">
          <p>Copyright © 2026 Netcradus. All rights reserved.</p>
