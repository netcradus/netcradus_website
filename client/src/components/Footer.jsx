        ...
        <footer className="border-t border-[var(--border-color)] bg-[var(--bg-color)] pt-16 md:pt-24 pb-12 z-10 relative mt-32 transition-colors duration-300">
            <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-16 lg:gap-24">
                ...
                <div className="col-span-1 md:col-span-1 space-y-8">
                    ...
                    {/* Ghost White Logos */}
                    <div className="pt-4 flex flex-wrap items-center gap-7 saturate-0 opacity-30 hover:saturate-100 hover:opacity-100 transition-all duration-700">
  <img src={isoLogo} alt="ISO 27001" className="h-16 w-auto object-contain" />
  <img src={iso27701Logo} alt="ISO 27701" className="h-16 w-auto object-contain" />
  <img src={msmeLogo} alt="MSME" className="h-14 w-auto object-contain" />
  <img src={kasperskyLogo} alt="Kaspersky" className="h-12 w-auto object-contain" />
</div>
