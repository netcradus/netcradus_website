...
export default function HowWeWork() {
    return (
        <SectionWrapper className="pt-8 md:pt-16 pb-16 md:pb-32 bg-[#050505] relative overflow-hidden">
            <div className="absolute inset-0 bg-[#ff8a1f]/[0.03] opacity-50 z-0" />
            
            <AnimatedReveal className="text-center mb-12 relative z-10">
                <span className="text-[10px] md:text-[12px] font-bold tracking-[0.4em] text-[#ff8a1f] uppercase mb-6 block">
                ...
                {steps.map((step, idx) => (
                    <AnimatedReveal key={idx} delay={idx * 0.1}>
                        <div className="group relative h-full p-8 border border-white/[0.03] bg-white/[0.01] hover:bg-white/[0.03] hover:border-white/[0.1] transition-all duration-700 rounded-2xl overflow-hidden">
                            {/* HUD Numbers */}
                            <div className="absolute top-6 right-8 text-4xl font-display font-black text-white/[0.02] group-hover:text-[#ff8a1f]/[0.05] transition-colors">
                                {step.time}
                            </div>
                            
                            <div className="relative z-10">
                                <span className="text-[9px] font-bold text-[#ff8a1f] uppercase tracking-[0.3em] mb-4 block">
                                    {step.label}
                                </span>
                                <h3 className="text-lg md:text-xl font-display font-bold text-white mb-4 leading-tight group-hover:text-[#ff8a1f] transition-colors">
                                    {step.title}
                                </h3>
                            ...
                            <div className="mt-auto flex justify-between items-center relative z-10">
                                <div className="w-10 h-10 rounded-lg bg-black border border-white/5 flex items-center justify-center text-gray-700 group-hover:text-[#ff8a1f] transition-all">
